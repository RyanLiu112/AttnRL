...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None, should_save_hf_model=False):
        """
        ...
        if self.should_save_hf_model and should_save_hf_model:
            ...
            if self.rank == 0:
                # change to the parent dir of local_path
                local_path_hf = os.path.dirname(local_path)
                hf_local_path = os.path.join(local_path_hf, "hf_model")
